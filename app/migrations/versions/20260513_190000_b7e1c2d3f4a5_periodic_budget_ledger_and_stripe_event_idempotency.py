...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_payment_id"], ["periodic_payments.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["rolled_over_from_id"],
            ["periodic_budget_ledger_entries.id"],
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_index(
        op.f("ix_periodic_budget_ledger_entries_id"),
        "periodic_budget_ledger_entries",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_periodic_budget_ledger_entries_team_id"),
        "periodic_budget_ledger_entries",
        ["team_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_periodic_budget_ledger_entries_region_id"),
        "periodic_budget_ledger_entries",
        ["region_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_periodic_budget_ledger_entries_entry_type"),
        "periodic_budget_ledger_entries",
        ["entry_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_periodic_budget_ledger_entries_source_invoice_id"),
        "periodic_budget_ledger_entries",
        ["source_invoice_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_periodic_budget_ledger_entries_stripe_payment_id"),
        "periodic_budget_ledger_entries",
        ["stripe_payment_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_periodic_budget_ledger_entries_expires_at"),
        "periodic_budget_ledger_entries",
        ["expires_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_periodic_budget_ledger_entries_rolled_over_from_id"),
        "periodic_budget_ledger_entries",
        ["rolled_over_from_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_periodic_budget_ledger_entries_is_active"),
        "periodic_budget_ledger_entries",
        ["is_active"],
        unique=False,
    )
