...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "limit_type",
            sa.Enum("CONTROL_PLANE", "DATA_PLANE", name="limittype"),
            nullable=False,
        ),
        sa.Column(
            "resource",
        ...
        sa.Column(
            "unit", sa.Enum("COUNT", "DOLLAR", "GB", name="unittype"), nullable=False
        ),
        sa.Column("max_value", sa.Float(), nullable=False),
        sa.Column("current_value", sa.Float(), nullable=True),
        sa.Column(
            "owner_type",
            sa.Enum("SYSTEM", "TEAM", "USER", name="ownertype"),
            nullable=False,
        ),
        sa.Column("owner_id", sa.Integer(), nullable=False),
        sa.Column(
            "limited_by",
            sa.Enum("PRODUCT", "DEFAULT", "MANUAL", name="limitsource"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_limited_resources_id"), "limited_resources", ["id"], unique=False
    )
