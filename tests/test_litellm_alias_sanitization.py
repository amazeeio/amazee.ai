...
def test_sanitize_alias_email():
    ...
    assert LiteLLMService.sanitize_alias("test@example.com - my-key") == "test_example.com_-_my-key"

def test_sanitize_alias_special_chars():
    """Test sanitization of special characters"""
    assert LiteLLMService.sanitize_alias("key!@#$%^&*()") == "key"
    assert LiteLLMService.sanitize_alias("key_with.dots/and-dashes") == "key_with.dots/and-dashes"
