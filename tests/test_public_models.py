...
def test_public_models_pricing_numeric_values(client, db):
    ...
    with patch("app.api.public.LiteLLMService") as mock_service_cls:
        ...
        assert pricing["input_cost_per_million_token"] == 5.0
        assert pricing["output_cost_per_million_token"] == 15.0
...
def test_public_models_pricing_missing_values(client, db):
    ...
    with patch("app.api.public.LiteLLMService") as mock_service_cls:
        ...
        assert pricing["input_cost_per_million_token"] is None
        assert pricing["output_cost_per_million_token"] is None
