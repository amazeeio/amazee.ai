...
def delete_key(key_name: str, user_email: str = None, db_username: str = None):
    ...
    try:
        ...
        for key in keys_to_delete:
            print(f"  - id: {key.id}, name: '{key.name}', owner_id: {key.owner_id}, db_username: '{key.database_username}'")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Force delete a Private AI Key from the database.")
