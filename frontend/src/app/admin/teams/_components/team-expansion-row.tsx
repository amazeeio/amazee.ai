...
export function TeamExpansionRow({
  ...
  const { data: teamAIKeys = [], isLoading: isLoadingTeamAIKeys } = useQuery<
    PrivateAIKey[]
  >({
  ...
  const { data: teamLimits = [], isLoading: isLoadingTeamLimits } = useQuery<
    LimitedResource[]
  >({
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div className="flex justify-end space-x-2 mt-4">
                          {expandedTeam.deleted_at ? (
                            <Button
                              variant="default"
                              onClick={() => restoreTeam(expandedTeam.id)}
                            ...
                            <>
                              ...
                              {(!expandedTeam.users ||
                                expandedTeam.users.length === 0) && (
                                <DeleteConfirmationDialog
                                  title="Delete Team"
                                  description="Are you sure you want to delete this team? This action cannot be undone."
                                  triggerText="Delete Team"
                                  onConfirm={() => deleteTeam(expandedTeam.id)}
                  ...
                  <TabsContent value="users" className="mt-4">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="space-x-2">
                        <Button
                          size="sm"
                          onClick={() => onAddUser(expandedTeam.id)}
                        >
                        ...
                        <Button
                          size="sm"
                          onClick={() => onCreateUser(expandedTeam.id)}
                        >
                  ...
                  <TabsContent value="shared-keys" className="mt-4">
                    <div className="space-y-4">
                      {isLoadingTeamAIKeys ? (
                          ...
                          <Table>
                            ...
                            <TableBody>
                              {teamAIKeys.map((key) => {
                                ...
                                const owner =
                                  usersMap[key.owner_id?.toString() || ""];
                                return (
                                  <TableRow key={key.id}>
                        ...
                        <div className="text-center py-8 border rounded-md">
                          <p className="text-muted-foreground">
                            No shared AI keys found for this team.
                          </p>
                        </div>
                      )}
                    </div>
