...
export default function TeamAdminPage() {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      <Card className="cursor-pointer" onClick={() => router.push('/team-admin/users')}>
        <CardHeader>
        ...
        <CardContent>
          <Button variant="secondary" className="w-full">View Team Users</Button>
        </CardContent>
      </Card>

      <Card className="cursor-pointer" onClick={() => router.push('/team-admin/private-ai-keys')}>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
