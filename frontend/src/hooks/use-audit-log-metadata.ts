...
export function useAuditLogMetadata(metadata: AuditLogMetadata | undefined): AuditLogMetadataOptions {
  return useMemo(() => {
    if (!metadata) return { eventTypes: [], resourceTypes: [], statusCodes: [] };
    return {
