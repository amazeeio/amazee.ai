      ...
      <SidebarProvider defaultOpen>
        ...
        >
          ...
          >
            {!collapsed && (
              <Link
                href={user?.role === "sales" ? "/sales" : "/private-ai-keys"}
            ...
            <SidebarProvider>
              <Sidebar className="border-r-0">
                <div className="flex h-16 items-center border-b px-6">
                  <Link
                    href={
                      user?.role === "sales" ? "/sales" : "/private-ai-keys"
                    }
                    className="flex items-center space-x-3"
                  >
                    <svg
        ...
        <main className="flex-1 transition-all duration-300 min-w-0">
          <div className="h-full w-full pl-0 pr-2 pt-6 sm:pr-4 lg:pr-6">
            {children}
          </div>
        </main>
      </SidebarProvider>
